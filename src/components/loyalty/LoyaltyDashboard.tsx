              ...
              {recentTransactions.map((transaction) => (
                <div key={transaction.id} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                  <div className="flex items-center gap-3">
                    <div className={`p-2 rounded-full ${transaction.type === 'EARNED'
                  ...
                  <div className={`text-sm font-semibold ${transaction.type === 'EARNED'
                      ? 'text-green-600'
                      : 'text-red-600'
                    }`}>
                ...
                <div key={reward.id} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                  ...
                  <div className="text-right">
                    ...
                    <button
                      ...
                      className={`text-xs px-3 py-1 rounded-full ${loyalty.points >= reward.pointsRequired
