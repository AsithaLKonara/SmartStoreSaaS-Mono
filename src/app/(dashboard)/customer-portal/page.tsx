  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-slate-400">Self-service portal for customers</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="glass-dark rounded-lg shadow p-6">
          ...
          <p className="text-slate-400 text-sm mb-4">Track your orders and view history</p>
        ...
        <div className="glass-dark rounded-lg shadow p-6">
          ...
          <p className="text-slate-400 text-sm mb-4">Save items for later purchase</p>
        ...
        <div className="glass-dark rounded-lg shadow p-6">
          ...
          <p className="text-slate-400 text-sm mb-4">View and redeem your points</p>
        ...
        <div className="glass-dark rounded-lg shadow p-6">
          ...
          <p className="text-slate-400 text-sm mb-4">Manage your account details</p>
        ...
        <div className="glass-dark rounded-lg shadow p-6">
          ...
          <p className="text-slate-400 text-sm mb-4">Request returns and refunds</p>
        ...
        <div className="glass-dark rounded-lg shadow p-6">
          ...
          <p className="text-slate-400 text-sm mb-4">Update preferences and notifications</p>
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between p-4 bg-white/5 rounded-lg">
            <div>
              ...
              <p className="text-sm text-slate-400">October 9, 2025</p>
            </div>
