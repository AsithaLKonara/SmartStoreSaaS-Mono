    ...
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-slate-400 dark:text-gray-400">Manage organizations and subscriptions</p>
        </div>
        <Button>
            ...
            <tbody className="glass-dark divide-y divide-gray-200">
              {tenants.map((tenant) => (
                <tr key={tenant.id} className="hover:bg-white/5">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-white">{tenant.email}</td>
                  <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-white">{formatDate(tenant.createdAt)}</td>
