            ...
            <CardContent className="space-y-3">
              ...
              <div className="flex items-center justify-between p-4 bg-gray-700/50 rounded-lg">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => setConfig({
                    ...config,
                    templates: { ...config.templates, orderConfirmation: checked }
                  })}
                />
              </div>
              ...
              <div className="flex items-center justify-between p-4 bg-gray-700/50 rounded-lg">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => setConfig({
                    ...config,
                    templates: { ...config.templates, shippingNotification: checked }
                  })}
                />
              </div>
              ...
              <div className="flex items-center justify-between p-4 bg-gray-700/50 rounded-lg">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => setConfig({
                    ...config,
                    templates: { ...config.templates, passwordReset: checked }
                  })}
                />
              </div>
              ...
              <div className="flex items-center justify-between p-4 bg-gray-700/50 rounded-lg">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => setConfig({
                    ...config,
                    templates: { ...config.templates, welcomeEmail: checked }
                  })}
                />
              </div>
              ...
              <div className="flex items-center justify-between p-4 bg-gray-700/50 rounded-lg">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => setConfig({
                    ...config,
                    templates: { ...config.templates, invoiceEmail: checked }
                  })}
                />
              </div>
            </CardContent>
