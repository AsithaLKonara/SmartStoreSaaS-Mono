            ...
            <CardContent className="space-y-3">
              ...
              <div className="flex items-center justify-between p-4 bg-gray-700/50 rounded-lg">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => setConfig({
                    ...config,
                    templates: { ...config.templates, shippingUpdate: checked }
                  })}
                />
              </div>
              ...
              <div className="flex items-center justify-between p-4 bg-gray-700/50 rounded-lg">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => setConfig({
                    ...config,
                    templates: { ...config.templates, deliveryNotification: checked }
                  })}
                />
              </div>
              ...
              <div className="flex items-center justify-between p-4 bg-gray-700/50 rounded-lg">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => setConfig({
                    ...config,
                    templates: { ...config.templates, otpVerification: checked }
                  })}
                />
              </div>
            </CardContent>
