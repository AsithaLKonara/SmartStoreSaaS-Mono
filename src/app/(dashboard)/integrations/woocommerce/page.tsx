...
export default function WooCommerceIntegrationPage() {
  ...
  const loadConfiguration = async () => {
    try {
      ...
      console.error('Error loading WooCommerce configuration:', error);
    } finally {
      setIsLoading(false);
    }
  };
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between p-4 bg-gray-700/50 rounded-lg">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => setConfig({
                      ...config,
                      syncSettings: { ...config.syncSettings, products: checked }
                    })}
                  />
                </div>
                ...
                <div className="flex items-center justify-between p-4 bg-gray-700/50 rounded-lg">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => setConfig({
                      ...config,
                      syncSettings: { ...config.syncSettings, orders: checked }
                    })}
                  />
                </div>
                ...
                <div className="flex items-center justify-between p-4 bg-gray-700/50 rounded-lg">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => setConfig({
                      ...config,
                      syncSettings: { ...config.syncSettings, customers: checked }
                    })}
                  />
                </div>
                ...
                <div className="flex items-center justify-between p-4 bg-gray-700/50 rounded-lg">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => setConfig({
                      ...config,
                      syncSettings: { ...config.syncSettings, inventory: checked }
                    })}
                  />
                </div>
              </div>
