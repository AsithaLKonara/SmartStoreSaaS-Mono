            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between p-4 bg-gray-700/50 rounded-lg">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => setConfig({
                    ...config,
                    paymentMethods: { ...config.paymentMethods, cards: checked }
                  })}
                />
              </div>
              ...
              <div className="flex items-center justify-between p-4 bg-gray-700/50 rounded-lg">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => setConfig({
                    ...config,
                    paymentMethods: { ...config.paymentMethods, applePay: checked }
                  })}
                />
              </div>
              ...
              <div className="flex items-center justify-between p-4 bg-gray-700/50 rounded-lg">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => setConfig({
                    ...config,
                    paymentMethods: { ...config.paymentMethods, googlePay: checked }
                  })}
                />
              </div>
              ...
              <div className="flex items-center justify-between p-4 bg-gray-700/50 rounded-lg">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => setConfig({
                    ...config,
                    paymentMethods: { ...config.paymentMethods, ach: checked }
                  })}
                />
              </div>
            </CardContent>
