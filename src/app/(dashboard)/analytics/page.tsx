    ...
    return (
      <div className="p-6">
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-white dark:text-white mb-2">No analytics data available</h3>
          <p className="text-slate-400">Start creating orders and customers to see analytics</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-white dark:text-white">Analytics</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="glass-dark rounded-lg shadow p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-white dark:text-white">Sales Trend</h3>
        ...
        <div className="glass-dark rounded-lg shadow p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-white dark:text-white">Payment Methods</h3>
            <Button variant="outline" size="sm">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="glass-dark rounded-lg shadow p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-white dark:text-white">Top Products</h3>
            <Button variant="outline" size="sm">
        ...
        <div className="glass-dark rounded-lg shadow p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-white dark:text-white">Top Customers</h3>
            <Button variant="outline" size="sm">
