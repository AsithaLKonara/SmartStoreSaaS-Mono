...
// Force dynamic since marketplace products update constantly
        ...
        {products.length === 0 ? (
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 lg:gap-6">
            {products.map((product) => (
              <div key={product.id} className="group bg-white border border-slate-200 rounded-xl overflow-hidden hover:shadow-xl transition-all duration-300 flex flex-col">
                ...
                <div className="p-4 flex-1 flex flex-col">
                  ...
                  <div className="mt-auto flex items-end justify-between">
                    ...
                    <button className="w-8 h-8 rounded-full bg-slate-100 hover:bg-indigo-600 hover:text-white text-slate-600 flex items-center justify-center transition-colors">
