...
import { Star, ShieldCheck, Truck, Store, ShoppingCart } from 'lucide-react';
        ...
        <div className="lg:col-span-3">
          <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-xl shadow-slate-200/50 sticky top-24">
            ...
            <button 
              ...
              className="w-full py-4 rounded-xl font-bold transition-all shadow-lg flex items-center justify-center space-x-2 disabled:bg-slate-100 disabled:text-slate-400 disabled:shadow-none bg-indigo-600 hover:bg-indigo-700 text-white shadow-indigo-500/30"
            >
              <ShoppingCart className="w-5 h-5" />
              <span>{product.stock > 0 ? 'Add to Global Cart' : 'Out of Stock'}</span>
            </button>
